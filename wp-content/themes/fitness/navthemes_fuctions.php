...
function thewest_entry_meta() {
	...
	$comment_number = sprintf( _n( '1 Коментарий', '%s Коментария', $comment_number, 'thewest' ), $comment_number );
...
/* ditrix review */
  $slider_image4 = thewest_get_resized_image_from_url(get_theme_mod("slider_image4", get_template_directory_uri() . "/images/slider-4.jpg"), "slider_image");
	$slider_title4 = get_theme_mod('slider_title4', 'Slider Title 3');
	$slider_text4 =  get_theme_mod('slider_text4', __('You can have anything here, which makes a good impression on your visitor', 'thewest'));
/* ditrix */
	...
	if($slider_image2[0]):								
  	...
  	if($slider_image4[0]):								
		echo'		<div id="slider_three" class="slider-item" style="height:611px; background-image:url('.   $slider_image4[0] . ');">
					<div class="overly_bg">
						<h1>'.$slider_title4.'</h1>
						<p>'.$slider_text4.'</p>
					</div>
