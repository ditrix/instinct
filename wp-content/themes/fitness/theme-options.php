...
Kirki::add_config( 'navthemes', array(
	...
	Kirki::add_section( 'navthemes_support', array(
			'title'          => __( 'NavThemes Suppor' , 'thewest' ),
			'priority'       => 1,
	) );
		...
		'default'     => '<div id="navthemes_branding">			<div class="navthemes-links">
...
/*=================================
  ...
  ================================= */
	...
	Kirki::add_panel( 'homepage', array(
		'priority'    => 10,
		'title'       => __( 'Свойства главной страницы', 'thewest' ),
		'description' => __( 'управление свойствами главной страницы', 'thewest' ),
	) );
	...
	Kirki::add_section( 'homepage_slider', array(
		'title'          => __( 'Свойства слайдера', 'thewest' ),
		'description'    => __( 'Управление изображениями, заголовками и подписями слайдера', 'thewest' ),
		'panel'          => 'homepage', 
		'priority'       => 160,
		'capability'     => 'edit_theme_options',
		...
		Kirki::add_field( 'navthemes', array(
				...
				'label'    => __( 'Slider Title 4', 'thewest' ),
				'section'  => 'homepage_slider',
				'type'     => 'text',
				'priority' => 10,
				'default'  => __('Slider Three Title', 'thewest'),
			...
			Kirki::add_field( 'navthemes', array(
				...
				'label'    => __( 'Slider Text 4', 'thewest' ),
				'section'  => 'homepage_slider',
				'type'     => 'text',
				'priority' => 10,
				'default'  => __('You can have anything here, which makes a good impression on your visitor', 'thewest'),
			...
			Kirki::add_field( 'navthemes', array(
				...
				'label'    => __( 'Slider Image 4', 'thewest' ),
				'section'  => 'homepage_slider',
				'type'     => 'image',
				'priority' => 10,
	...
	--------------------------------------------------------------------------*/
		...
		Kirki::add_section( 'homepage_services', array(
			'title'          => __( 'Секция сервисы', 'thewest' ),
			'description'    => __( 'From here you can manage Home Page about us section' , 'thewest' ),
			'panel'          => 'homepage', 
			'priority'       => 160,
			'capability'     => 'edit_theme_options',
  ...
  /*ditrix*/
     	Kirki::add_field( 'navthemes', array(
				'settings' => 'homepage_services_title4',
				'label'    => __( 'Services Title 4', 'thewest' ),
				'section'  => 'homepage_services',
				'type'     => 'text',
				'priority' => 10,
				'default'  => __('Services Title Four', 'thewest'), 
			 
			) );
			
  		Kirki::add_field( 'navthemes', array(
				'settings' => 'homepage_services_text4',
				'label'    => __( 'Services Text 4', 'thewest' ),
				'section'  => 'homepage_services',
				'type'     => 'textarea',
				'priority' => 10,
				'default'  => __('You can anything related to your Services. Pellentesque nulla magna, accumsan sed ante quis, gravida feugiat turpis.', 'thewest' ), 
  	...
  	Kirki::add_field( 'navthemes', array(
				'settings' => 'homepage_services_image4',
				'label'    => __( 'Services Image 4', 'thewest' ),
				'section'  => 'homepage_services',
				'type'     => 'image',
				'priority' => 10,
				'default'  => get_template_directory_uri() . '/images/service-image-4.jpg',
