  ...
  <div class="post_block">
	...
	?>
        ...
        <?php 
	 	if ( !is_single() ) : 
     ?>
     	 <a href="<?php echo esc_url(get_the_permalink()); ?>" class="readmore pull-right"><?php _e('Подробнее', 'thewest'); ?></a> 
    ...
    <div class="clearboth"></div> 
 	...
 	<footer class="entry-footer">
		<?php edit_post_link( __( 'Изменить', 'thewest' ), '<span class="edit-link">', '</span>' ); ?>
	</footer><!-- .entry-footer -->
