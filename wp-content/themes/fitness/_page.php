         ...
         <section class="services_wrapper">
                 <div class="container">
                    <div class="row">
                          ...
                          <div class="col-md-3 col-sm-3">
                                <img src="<?php echo thewest_get_resized_only_image_from_url(get_theme_mod('homepage_services_image4' , get_template_directory_uri() . '/images/service-image-4.jpg'),'services_image');  ?>">
                                <h3><?php echo get_theme_mod('homepage_services_title4' , __('Services Title Three', 'thewest'));  ?></h3>
                                <p><?php echo get_theme_mod('homepage_services_text4' , __('You can anything related to your Services. Pellentesque nulla magna, accumsan sed ante quis, gravida feugiat turpis.', 'thewest'));  ?></p>
                          </div>
