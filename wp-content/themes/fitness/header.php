                        ...
                        <li class="sidebar-brand">
                            ...
                            <div class="menu">
                             <?php if ( has_nav_menu( 'primary' ) ) { ?>
                               ...
                               <?php if ( trim( get_theme_mod('social_pinterest') != '') ) { ?>
                                ...
                                <?php if ( trim( get_theme_mod('social_tumblr') != '') ) { ?>
